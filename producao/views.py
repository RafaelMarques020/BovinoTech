...
def index(request):
    ...
    return render(request, 'index.html', {'alertas': alertas, 'total_alertas': total_alertas_nao_lidos})
...
def deletar_animal(request, pk):
    ...
    if request.method == 'POST':
        animal.delete()
        return redirect('lista_animais')
    return render(request, 'deletar_animal.html', {'animal': animal})
...
def lançar_producao(request):
    ...
    return render(request, 'lancar_producao.html', {'form': form})
...
def controle_individual(request):
    ...
    return render(request, 'controle_individual.html', context)
...
def editar_producao(request, pk):
    ...
    return render(request, 'editar_producao.html', {'form': form, 'producao': producao})
...
def deletar_producao(request, pk):
    ...
    if request.method == 'POST':
        producao.delete()
        return redirect('historico_producao')
    return render(request, 'deletar_producao.html', {'producao': producao})

# RF6: Vacinação
def vacinacao(request):
    vacinas = Vacinacao.objects.all().order_by('-data_aplicacao')
    return render(request, 'vacinacao.html', {'vacinas': vacinas})
...
def criar_vacinacao(request):
    ...
    return render(request, 'criar_vacinacao.html', {'form': form})
...
def editar_vacinacao(request, pk):
    ...
    return render(request, 'editar_vacinacao.html', {'form': form, 'vacinacao': vacinacao})
...
def deletar_vacinacao(request, pk):
    ...
    if request.method == 'POST':
        vacinacao.delete()
        return redirect('vacinacao')
    return render(request, 'deletar_vacinacao.html', {'vacinacao': vacinacao})

# RF7: Medicamentos
def medicamentos(request):
    meds = Medicamento.objects.all().order_by('-data_inicio')
    return render(request, 'medicamentos.html', {'medicamentos': meds, 'today': date.today()})
...
def criar_medicamento(request):
    ...
    return render(request, 'criar_medicamento.html', {'form': form})
...
def deletar_medicamento(request, pk):
    ...
    if request.method == 'POST':
        medicamento.delete()
        return redirect('medicamentos')
    return render(request, 'deletar_medicamento.html', {'medicamento': medicamento})

# RF8: Controle Sanitário
def controle_sanitario(request):
    registros = ControleSanitario.objects.all().order_by('-data_registro')
    return render(request, 'sanitario.html', {'registros': registros})
...
def criar_sanitario(request):
    ...
    return render(request, 'criar_sanitario.html', {'form': form})
...
def editar_sanitario(request, pk):
    ...
    return render(request, 'editar_sanitario.html', {'form': form, 'sanitario': sanitario})
...
def deletar_sanitario(request, pk):
    ...
    if request.method == 'POST':
        sanitario.delete()
        return redirect('sanitario')
    return render(request, 'deletar_sanitario.html', {'sanitario': sanitario})
...
def controle_reprodutivo(request):
    ...
    return render(request, 'reprodutivo.html', {
        'registros': registros,
...
def criar_reprodutivo(request):
    ...
    return render(request, 'criar_reprodutivo.html', {'form': form})
...
def editar_reprodutivo(request, pk):
    ...
    return render(request, 'editar_reprodutivo.html', {'form': form, 'reprodutivo': reprodutivo})
...
def deletar_reprodutivo(request, pk):
    ...
    if request.method == 'POST':
        reprodutivo.delete()
        return redirect('reprodutivo')
    return render(request, 'deletar_reprodutivo.html', {'reprodutivo': reprodutivo})
